...
namespace View.Converters
{
    public class CombiningVisibilityConverter: IValueConverter
    {
        ...
        {
            var convertedValue = InverseBooleanConverter.Convert(value, targetType, parameter, culture);
            return VisibilityConverter.Convert(convertedValue, targetType, parameter, culture);
        }
